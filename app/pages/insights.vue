  ...
  <div class="min-h-screen bg-slate-950 relative overflow-hidden">
    ...
    <main v-else v-if="summary" class="relative max-w-7xl mx-auto px-6 pt-10 pb-24 space-y-6">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <!-- Total Spent -->
        <div class="relative rounded-2xl border border-white/[0.08] bg-gradient-to-br from-white/[0.05] to-white/[0.01] p-5 overflow-hidden hover:border-red-600/30 hover:bg-gradient-to-br hover:from-white/[0.08] transition-all duration-300 group">
          <div class="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-red-600/50 to-transparent"></div>
          <div class="flex items-center justify-between mb-4">
            ...
            <div class="w-7 h-7 rounded-lg bg-red-600/15 border border-red-600/25 flex items-center justify-center">
          ...
          <div class="space-y-4">
            <div>
              ...
              <div class="w-full bg-white/[0.05] rounded-full h-1">
                <div class="h-1 rounded-full bg-gradient-to-r from-red-600 to-red-500" :style="{ width: Math.min((totalSpent / totalIncome * 100) || 0, 100) + '%' }"></div>
              </div>
            </div>
...
const getTopTransactions = (categoryName, monthName) => {
  ...
  // Convert month name (e.g., "DEC", "DIC") to month number (12)
  // Use separate maps for English and Spanish to avoid duplicates
  const monthMapEN = {
  ...
  let monthNum = monthMapEN[upperMonth] || monthMapES[upperMonth] || 0
